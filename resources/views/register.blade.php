...
<body style="background-color: #B9579C">
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block "><img src="{{asset('iglesia.jpg')}}"  style="width:400px;height:670px;"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
